...
enum
{
	...
	AP_LEVELSELECTORDER_MAP_ORDER_UP,
	AP_LEVELSELECTORDER_MAP_ORDER_DOWN,
	AP_LEVELSELECTORDER_MAP_ORDER_AUTO,
...
enum
{
    ...
    WIDGETS_STBAR = NUM_WIDGETS_BASIC,
    WIDGETS_STBAR_ALWAYS,
    NUM_WIDGETS
};
