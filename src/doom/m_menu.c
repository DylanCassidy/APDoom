...
static void M_DrawCrispness2(void)
{
    ...
    // [AP] show player coords as unavailable in race mode
    M_DrawCrispnessMultiItem(crispness_playercoords, "Show Player Coords", multiitem_widgets, crispy->playercoords, !ap_race_mode);
