...
// [crispy] remove " to dos.)"
// [AP] put it back, this makes deh string replacements fail.
...
#define GOTREVENANTTRAP "A trio of Revenants are looming around"
#define GOTLOSTSOULTRAP "Many Lost Souls have appeared"
